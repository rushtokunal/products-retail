...
class Database(object):
    def __init__(self):
        ...
        my_collection = self.db['product-loc-retail']
        index_name = 'product_retl_idx'
    ...
    def find_by_id(self, product_id, collection_name):
        ...
        if found is None:
            return "product retail doesnt exists"
    ...
    def update(self, product_id, element, collection_name):
